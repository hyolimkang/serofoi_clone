...
row_vector lambda_yexpo_fun (row_vector lambda,
 ...
 row_vector[Ymax] lambda_yexpo;
  ...
  int EndDec4   = StartDec3-1;
   ...
   for (j in StartDec1: EndDec1) lambda_yexpo[j] = lambda[4];
   for (k in StartDec2: EndDec2) lambda_yexpo[k] = lambda[3];
   for (l in StartDec3: EndDec3) lambda_yexpo[l] = lambda[2];
   for (m in StartDec4: EndDec4) lambda_yexpo[m] = lambda[1];
   return lambda_yexpo;
  }
}
